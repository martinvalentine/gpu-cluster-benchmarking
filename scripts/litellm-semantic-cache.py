...
Usage:
    ...
    python scripts/litellm-semantic-cache.py

    # Start with custom settings
    python scripts/litellm-semantic-cache.py --port 4000

    # Flush cache
    python scripts/litellm-semantic-cache.py --flush

    # Show cache stats
    python scripts/litellm-semantic-cache.py --stats
"""
